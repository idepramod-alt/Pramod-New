...
public final class LongSaturatedMathKt {
    ...
    private static final long infinityOfSign(long value) {
        return value < 0 ? Duration.Companion.m1655getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.Companion.m1654getINFINITEUwyO8pc();
    }
    ...
    public static final long saturatingOriginsDiff(long origin1, long origin2, DurationUnit unit) {
        ...
        if ($i$f$isSaturated != 0) {
            return origin1 == origin2 ? Duration.Companion.m1656getZEROUwyO8pc() : Duration.m1606unaryMinusUwyO8pc(infinityOfSign(origin2));
        }
