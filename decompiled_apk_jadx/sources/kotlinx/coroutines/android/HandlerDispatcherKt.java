...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m227constructorimpl = Result.m227constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m227constructorimpl = Result.m227constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m233isFailureimpl(m227constructorimpl) ? null : m227constructorimpl;
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1799dispatch(cont.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
